...
const contactData = [
  {
    ...
    href: "https://maps.google.com/?q=Kuwait+Magic+Mall",
    external: true,
  },
  {
    icon: (
    ...
    labelKey: "mobileLabel" as const,
    value: "+965 9903 7473",
    href: "tel:+96599037473",
    external: false,
  },
  {
    icon: (
  ...
  },
  {
    ...
    value: "info@lightnessgym.com",
    href: "mailto:info@lightnessgym.com",
    external: false,
  },
];
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-dark py-16 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        >
          <div className="section-label">{tr.contact.label}</div>
        ...
        <div className="mt-10 grid gap-8 sm:mt-16 lg:grid-cols-2 lg:gap-12">
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3485.03754583!2d48.130291915094055!3d29.134084182222583!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3fcf08ef9baa79d9%3A0x1a0ebc12eb6d51f0!2sKuwait%20Magic%20Mall!5e0!3m2!1sen!2skw!4v1573817873571!5m2!1sen!2skw"
              width="100%"
              height="100%"
              ...
              title="Lightness Gym Location - Kuwait Magic Mall"
